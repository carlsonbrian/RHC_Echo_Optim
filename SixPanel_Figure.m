...
% ***********************************************************************************
    ...
    if (NormParam_Flag == 1)
        ...
        if (RHCEcho_Flag == 1)
            ...
            P_SASim = SimPlot_Struct.P_AOSim;
            P_PASim = SimPlot_Struct.P_PASim;
            P_PUSim = SimPlot_Struct.P_PUSim;
            ...
            P_SVSim = SimPlot_Struct.P_VCSim;
    ...
    %% SUBPLOT OF P_RV, P_SA, P_PA AND P_PU AND COMP TO DATA IF PRESENT
    subplot(2,3,1)
    ...
    elseif (Comp2Norm_Flag == 1)
        PMax_SP1 = 1.45 * ...
            max([max(P_AOSim) max(P_AOSimNorm)]);
