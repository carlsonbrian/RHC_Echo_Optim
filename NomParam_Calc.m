...
% ***********************************************************************************
    ...
    % PUMLONARY ARTERIAL AND VENOUS PARAMETERS
    ...
    % SYSTEMIC ARTERIAL AND VENOUS PARAMETERS
    Esa_Nom = (P_SAsyst - P_SAdiast) / V_SAsyst;        % Nom systemic art elastance
    Esv_Nom = PSVpp_Nom / V_SVsyst;                     % Nom systemic ven elstnce
    ...
    Rmval_Nom = ((PPVdiast_Nom - PLVdiast_Nom) / ...    % Nom mtrl vlv resist
        CO_RHC) * (60/1000);                            %  with conv to mmHg*s/mL
    Raval_Nom = ((PLVsyst_Nom - P_AOsyst) / ...         % Nom artc vlv resist
        CO_RHC) * (60/1000);                            %  with conv to mmHg*s/mL
    if (P_RVdiast <= 0)                                 % Again if P_RVdiast is
    ...
    NomParam_Values = {Elv_Nom P0lv_Nom lambdalv_Nom ...
        ...
        Rpul_Nom Esa_Nom Esv_Nom Rsys_Nom Rmval_Nom Raval_Nom ...
        Rtval_Nom Rpval_Nom};
